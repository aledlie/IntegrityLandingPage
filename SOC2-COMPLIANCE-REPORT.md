...
**Overall Compliance Status**: PARTIAL - SOC 2 Certification Pending
...
| Service | DPA Status | Agreement Type | Notes |
|---------|------------|----------------|-------|
| **Google Analytics** | Covered | Google Ads Data Processing Terms | Auto-accepted via Google Cloud/Workspace account; covers GA4, GTM |
| **Meta (Facebook Pixel)** | Covered | Meta Data Processing Terms | Accepted via Meta Business Suite; includes GDPR Standard Contractual Clauses |
| **Calendly** | Covered | Calendly DPA | Available at calendly.com/dpa; includes GDPR SCCs |
| **Cloudflare (Workers)** | Covered | Cloudflare DPA | Auto-included with Enterprise; self-service available at cloudflare.com/cloudflare-customer-dpa |
...
**Generated By**: Compliance Report Generator (Claude Code)
